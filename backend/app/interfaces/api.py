...
from app.interfaces.prediction_router import router as prediction_router
...
from app.interfaces.research_dashboard_router import router as research_dashboard_router
