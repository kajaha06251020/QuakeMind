"""Test IRIS client."""
import pytest
from app.infrastructure.iris_client import fetch_recent_events, _parse_fdsn_text
...
async def test_fetch_disabled(db_engine):
    ...
    with patch("app.infrastructure.iris_client.settings") as mock:
        mock.iris_enabled = False
