"""Test INGV client."""
import pytest
from app.infrastructure.ingv_client import fetch_recent_events, _parse_fdsn_text
...
async def test_fetch_disabled(db_engine):
    ...
    with patch("app.infrastructure.ingv_client.settings") as mock:
        mock.ingv_enabled = False
